...
public class TeacherLoginFilter implements Filter{
	...
	private static final String LOGIN_PREFIX_TEACHER = "/Teacher/",
								LOGIN_PAGE = "/index.jsp";
	public static final String 	ATTR_ADMINUSER_TEACHER = "tno";
	...
	public void doFilter(ServletRequest arg0, ServletResponse arg1, FilterChain arg2)
        ...
        if(requestURI.indexOf(LOGIN_PREFIX_TEACHER) != -1 && session.getAttribute(ATTR_ADMINUSER_TEACHER) == null ){
